...
export const EditProductPage = () => {
  ...
  const [isLoading, setIsLoading] = useState(false);
	...
	return (
		<Container maxWidth="lg" sx={{ pt: 3 }} className="animate__animated animate__fadeIn">
      ...
      <Grid container justifyContent={'center'} mb={5}>
        <Grid item xs={12} md={5}>
          ...
          <Stack gap={2} mb={5}>
            <CustomButton variant={"contained"} fullWidth onClick={handleSaveProduct}>Guardar producto</CustomButton>
