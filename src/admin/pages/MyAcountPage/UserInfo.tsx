    ...
    <Box py={5}>
      <Grid container justifyContent={'center'}>
        <Grid item xs={8}>
          ...
          <Typography variant={'h6'} color={'primary'} mb={3}>Información de tu cuenta</Typography>

          <Grid container rowSpacing={2} columnSpacing={3} mb={3}>
            <Grid item xs={7}>
              <Box mb={5}>
                <Typography variant="caption" display="block" gutterBottom>Nombre y Apellido:</Typography>
                <Typography variant="body1" display="block" gutterBottom>Joe Doe</Typography>
              </Box>
              ...
              <Box mb={5}>
                <Typography variant="caption" display="block" gutterBottom>Contraseña:</Typography>
                <Typography variant="body1" display="block" gutterBottom>******</Typography>
              </Box>
            </Grid>
